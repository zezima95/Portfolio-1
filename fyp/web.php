...
<style>
<?php include "D:/Wamp/www/fyp/css/web/kickstart.css"?></style>
                  <!-- KICKSTART -->
<style>
	<?php include "D:/Wamp/www/fyp/css/web/style.css"?></style>                          

<!-- CUSTOM STYLES -->
<script>
	<?php include "D:/Wamp/www/fyp/js/web/kickstart.js"?></script>
                                  <!-- KICKSTART -->
</head><body>
...
<li><a href=""><span class="icon" data-icon="R"></span>Item 3</a>
	...
	<li><a href=""><i class="fa fa-arrow-circle-right"></i> Sub Item</a>
		<ul>
		<li><a src=""><i class="fa fa-comments"></i> Sub Item</a></li>
		<li><a src=""><i class="fa fa-check"></i> Sub Item</a></li>
		<li><a src=""><i class="fa fa-cutlery"></i> Sub Item</a></li>
		<li><a src=""><i class="fa fa-cube"></i> Sub Item</a></li>
		</ul>
	</li>
